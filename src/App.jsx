  ...
  const projectsData = [
    {
      ...
      title: "ARDUINO-DRIVEN SMART LOCK SECURITY SYSTEM FOR COMPUTER LABORATORY FOR DEPARTMENT OF COMPUTER STUDIES IN CVSU IMUS",
    ...
    {
      type: 'project',
      src: "/clinton-portfolio1/camerino-water.jpg", // You may need to create or rename a generic image for this
      ...
      docLink: "",
      isLocked: true // Triggers blur and "Coming Up"
    }
  ];
      ...
      <section id="projects" className="w-full py-24 bg-gray-50 border-t border-gray-100 px-6 md:px-12 scroll-mt-24">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h4 className="text-4xl font-black text-gray-900 tracking-tight uppercase">Projects</h4>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {projectsData.map((project, index) => (
              ...
              >
                ...
                <div className="p-6 md:p-8 flex-1 flex flex-col justify-between bg-white z-30">
                  <div>
                    <h5 className="text-xl font-bold text-gray-900 mb-3">{project.title}</h5>
                    <p className="text-sm text-gray-500 line-clamp-3 mb-4 leading-relaxed">{project.description}</p>
                  </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-[#2a2656] p-8 md:p-10 rounded-3xl shadow-xl border border-white/5 flex flex-col justify-between">
              ...
              <form action="https://formsubmit.co/clinton.malicdon0@gmail.com" method="POST" className="space-y-6">
                
                {/* FormSubmit Configuration */}
                <input type="hidden" name="_subject" value="New message from Portfolio!" />
                <input type="hidden" name="_captcha" value="false" />
                {/* Optional: Add this line below to redirect users after sending. Just replace the URL with your live site link later */}
                ...
                <button type="submit" className="w-full bg-gradient-to-r from-violet-500 to-fuchsia-500 hover:from-violet-600 hover:to-fuchsia-600 text-white font-bold py-4 rounded-xl transition-all transform hover:scale-[1.02] shadow-lg">
                  Send Message
                </button>
              </form>
      ...
      {lightboxData && (
        <div className="fixed inset-0 bg-gray-950/98 backdrop-blur-md z-50 flex items-center justify-center p-4 md:p-8" onClick={() => setLightboxData(null)}>
          <div className="bg-[#0d1527] border border-slate-800 rounded-2xl overflow-hidden shadow-2xl flex flex-col md:grid md:grid-cols-12 max-w-5xl w-full max-h-[90vh] relative" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="md:col-span-7 flex items-center justify-center relative min-h-[350px] md:min-h-[500px] overflow-hidden">
              <img 
              ...
              {lightboxData.isLocked && (
                <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center z-20">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
                  <span className="text-white font-black uppercase tracking-widest text-lg mt-4">Coming Up</span>
                </div>
              )}
            </div>
            ...
            <div className="md:col-span-5 p-8 flex flex-col justify-center text-center bg-[#0d1527] border-t md:border-t-0 md:border-l border-slate-800 text-white overflow-y-auto">
              ...
              {lightboxData.type === 'project' && (
                <>
                  <h4 className="text-2xl font-black mb-4 tracking-wide text-white uppercase leading-snug">{lightboxData.title}</h4>
                  <div className="border-b border-slate-800/80 pb-6 mb-6">
                    <p className="text-sm font-medium text-slate-300 leading-relaxed text-justify mb-4">{lightboxData.description}</p>
                    <span className="text-xs uppercase tracking-widest text-blue-500 font-bold block">Tech Stack</span>
                    <p className="text-xs font-mono text-slate-400 mt-2">{lightboxData.techStack}</p>
                  </div>
